...
export default async function handler(req, res) {
  ...
  try {
    ...
    return res
      .status(500)
      .json({ ok: false, error: "Erro ao gerar métricas" });
  }
}